...
class _SplashPageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double logoSize =
        isSmallScreen
            ? size.width *
                0.8 // Küçük ekranlarda ekran genişliğinin %80'i
            : size.width * 0.6; // Büyük ekranlarda ekran genişliğinin %60'ı

    // Text logo height calculation
    final double textLogoHeight =
        isSmallScreen
            ? size.height *
                0.08 // Küçük ekranlarda ekran yüksekliğinin %8'i
            : size.height * 0.06; // Büyük ekranlarda ekran yüksekliğinin %6'sı

    // Spacing calculations
    final double verticalSpacing = size.height * 0.2; // Ekran yüksekliğinin %20'si
